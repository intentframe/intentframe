...
class ExecutorBridge:
    ...
    def create_for_demo(
        ...
        from intentframe_native_kit.intentframe_executor_pack_console import register_all as register_console_pack
        from intentframe_native_kit.intentframe_executor_pack_macos import register_all

        register_console_pack()
        register_all()

        # ── Auth verifier ────────────────────────────────────────────────
        from intentframe_native_kit.intentframe_executor_pack_macos.auth import GuardianHMACVerifier
        ...
        from intentframe_native_kit.intentframe_executor_pack_macos.state_store import SQLiteStateStore
        ...
        from intentframe_native_kit.action_registry import ActionCatalog
        from intentframe_native_kit.action_registry.platforms.macos import register_macos_actions
