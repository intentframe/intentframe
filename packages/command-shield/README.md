...
PyPI: [command-shield](https://pypi.org/project/command-shield/) · `pip install command-shield==0.1.1` · License: Apache-2.0 · [Consumer guide](../../docs/package-consumers.md)
