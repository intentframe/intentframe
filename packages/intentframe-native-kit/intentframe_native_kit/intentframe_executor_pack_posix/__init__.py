...
Platform packs (e.g. intentframe_native_kit.intentframe_executor_pack_macos) layer native adapters and
OS-specific backends on top of this base.

Usage:
    from intentframe_native_kit.intentframe_executor_pack_posix import register_all
    register_all()
"""
...
def _register_transport() -> None:
    ...
    from intentframe_native_kit.intentframe_executor_pack_posix.transport import UnixSocketTransport
...
def _register_auth() -> None:
    ...
    from intentframe_native_kit.intentframe_executor_pack_posix.auth import GuardianHMACVerifier
...
def _register_storage() -> None:
    ...
    from intentframe_native_kit.intentframe_executor_pack_posix.audit_logger import SQLiteAuditLogger
    from intentframe_native_kit.intentframe_executor_pack_posix.state_store import SQLiteStateStore
...
def _register_adapters() -> None:
    from intentframe_native_kit.intentframe_executor_pack_posix.adapters import register_all_adapters
