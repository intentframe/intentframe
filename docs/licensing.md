...
IntentFrame uses a split license model across publishable workspace packages (`packages/`). Publishing to PyPI (groups, rate limits, CI vs local): [`scripts/release/README.md`](../scripts/release/README.md). Interim GitHub release wheels (publish, install verify, runtime boot): [`scripts/github-release/README.md`](../scripts/github-release/README.md), [`scripts/github-install/README.md`](../scripts/github-install/README.md).
